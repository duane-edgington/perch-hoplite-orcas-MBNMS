...
**`score_orca_regions.py`** — threshold sweep against known ground-truth regions. This is how each model's operating threshold was checked: false positives collapse under thresholding on near-silent months while confirmed events retain most of their detections.
